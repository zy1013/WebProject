...
<body>
			...
			<div class="main-content">
				<div id="content" class="container-fluid">
					...
					<div id="tagdiv" class="row">
						<div class="col-md-4">
							<button type="button" onclick="selectTag(this);" class="btn btn-default"><i class="fa fa-plus-square"></i> Default </button>
	...
	<script>
		...
		$("#tagdiv").append("<div class=\"col-md-4\"><button type=\"button\" onclick=\"selectTag(this);\" class=\"btn btn-default\"><i class=\"fa fa-plus-square\"></i> "+name+" </button></div>");}
