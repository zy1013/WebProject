					...
					<ul class="nav">
						...
						<li>
							...
							<div id="subPages3" class="collapse ">
								<ul class="nav">
									<li><a href="createchannel" class="">创建频道</a></li>
									<li><a href="channelsetting" class="">频道管理</a></li>
									<li><a href="discover" class="">发现频道</a></li>
								</ul>
							</div>
						</li>
						<li>
						...
						<li><a href="message" class=""><i class="lnr lnr-alarm"></i> <span>通知</span></a></li>
							...
							<div class="panel">
								...
								<div class="panel-body no-padding">
									<table class="table table-striped">
										...
										<tbody>
											<tr>
												<td><a onclick="fun_a()"">763648</a></td>
												<td>Steve</td>
												<td>$122</td>
												<td>Oct 21, 2016</td>
												<td><span class="label label-success">COMPLETED</span></td>
